  ...
  return (
    <footer className="bg-neutral-900 border-t border-neutral-800 mt-16">
        <div className="container mx-auto py-8 px-4 md:px-8 text-center text-neutral-500">
            ...
            <br />Made by <a href="https://github.com/lucas-bonato" target="_blank" className="text-primary hover:text-primary-dark transition-colors duration-300">@lucas-bonato</a>.</p>
        </div>
    </footer>
  );
};
